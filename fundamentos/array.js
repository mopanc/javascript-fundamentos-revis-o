...
console.log(valores[4])//não devolve o valor porque ainda nao foi definido, devolve undefined

valores[4] = 10 //aqui atribuimos ao valor 4 o 10
console.log(valores)//aqui mostra os valores da array
console.log(valores.length)// aqui mostra quantos valores tem a array

valores.push({id: 3}, false, null, 'teste')//aqui para mostrar que podemos misturar varios valores inclusive strings
console.log(valores)
