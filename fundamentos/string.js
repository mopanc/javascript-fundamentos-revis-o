...
console.log(escola.charAt(4))/*aqui estamos a pedir que nos devolva a 4 letra do que escola recebeu,
 ou seja coder, vai devolver r pois sendo indexada o 0 tambem é numero
 */
...
console.log(escola.substring(0, 3))/* va do indice 0 e va ate ao indece 3 aqui imprime do 0 ate
 ao 3 mas não imprime o 3 imprime o 0, 1, 2 cod
*/

console.log('escola '.concat(escola).concat("!"))/*aqui podemos fazer de duas formas, assim e a de baixo,
 ele vai concatenar as strings entre aspas junto com a variavel
*/
